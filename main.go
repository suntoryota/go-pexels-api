...
type Video struct {
	...
	VideoPicture []VideoPicture `json:"video_picture"`
}
...
func main() {
	os.Setenv("PexelsToken", "563492ad6f91700001000001ef55e07dca9b4d00992d0a62db0e3891")
	...
	// if result.Page == 0 {
	// 	fmt.Printf("Search result nil wrong")
	// }
